...
import com.chlqudco.develop.sejong2022capstoneteam8.Mlkit.*
    ...
    return task
      .addOnSuccessListener(
        ...
        OnSuccessListener { results: T ->
          ...
          minFrameMs = kotlin.math.min(currentFrameLatencyMs, minFrameMs)
          totalDetectorMs += currentDetectorLatencyMs
          maxDetectorMs = max(currentDetectorLatencyMs, maxDetectorMs)
          minDetectorMs = kotlin.math.min(currentDetectorLatencyMs, minDetectorMs)
