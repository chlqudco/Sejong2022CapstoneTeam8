...
object PoseEmbedding {
    ...
    private fun normalize(landmarks: List<PointF3D?>): ArrayList<PointF3D?> {
        val normalizedLandmarks: ArrayList<PointF3D?> = ArrayList(landmarks)
    ...
    private fun getPoseSize(landmarks: ArrayList<PointF3D?>): Float {
    ...
    private fun getEmbedding(lm: ArrayList<PointF3D?>): List<PointF3D> {
