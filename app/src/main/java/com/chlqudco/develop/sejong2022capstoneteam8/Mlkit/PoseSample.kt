...
import com.chlqudco.develop.sejong2022capstoneteam8.Mlkit.PoseEmbedding.getPoseEmbedding
import com.google.mlkit.vision.common.PointF3D
import com.chlqudco.develop.sejong2022capstoneteam8.Mlkit.PoseSample
import com.chlqudco.develop.sejong2022capstoneteam8.Mlkit.PoseEmbedding
...
class PoseSample(val name: String, val className: String, landmarks: List<PointF3D?>?) {
    ...
    init {
        embedding = getPoseEmbedding(landmarks!!)
    }
}